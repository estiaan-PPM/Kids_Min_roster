<x-layout>
    ...
    <form method="POST" action="/kid/{{$kid->name}}">
        @csrf
        @method('PATCH')
        ...
        <div class="mt-6 flex items-center justify-between gap-x-6">
          ...
          <div class="flex items-center gap-x-6">  
            <a href="/kid/{{$kid->name}}" class="text-sm/6 font-semibold text-gray-900">Cancel</a>
            <div>
      ...
      <form method="POST" action="/kid/{{$kid->name}}" id="delete-form" class="hidden">
        @csrf
        @method('DELETE')
      </form>
